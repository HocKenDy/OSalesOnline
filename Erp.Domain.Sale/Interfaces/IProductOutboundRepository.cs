...
namespace Erp.Domain.Sale.Interfaces
{
    public interface IProductOutboundRepository
    {
        ...
        ProductOutbound GetProductOutboundByCode(string code);
        vwProductOutbound GetvwProductOutboundById(int Id);
        vwProductOutbound GetFullvwProductOutboundById(int Id);
        vwProductOutbound GetFullvwProductOutboundByCode(string Code);
