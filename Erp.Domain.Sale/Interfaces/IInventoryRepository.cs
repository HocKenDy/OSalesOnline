...
namespace Erp.Domain.Sale.Interfaces
{
    public interface IInventoryRepository
    {
        ...
        IQueryable<vwInventory> GetAllvwInventoryByWarehouseIdAndProductManufacturer(int? Id, string Manufacturer);
        IQueryable<vwInventory> GetAllvwInventoryByProductManufacturer(string Manufacturer);
