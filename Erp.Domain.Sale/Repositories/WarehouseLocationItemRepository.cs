...
namespace Erp.Domain.Sale.Repositories
{
    public class WarehouseLocationItemRepository : GenericRepository<ErpSaleDbContext, WarehouseLocationItem>, IWarehouseLocationItemRepository
    {
        ...
        {
            return Context.vwWarehouseLocationItem.Where(item => (item.IsDeleted == null || item.IsDeleted == false));
        }
        ...
        {
            return Context.WarehouseLocationItem.SingleOrDefault(item => item.WarehouseId == warehouseId && item.ProductId == productId && item.SN == serialNumber && (item.IsDeleted == null || item.IsDeleted == false));
        }
