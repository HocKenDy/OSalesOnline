...
namespace Erp.Domain.Sale.Repositories
{
    public class ProductOutboundRepository : GenericRepository<ErpSaleDbContext, ProductOutbound>, IProductOutboundRepository
    {
        ...
        public ProductOutbound GetProductOutboundByCode(string code)
        {
            return Context.ProductOutbound.SingleOrDefault(item => item.Code == code);
        }
        ...
        public vwProductOutbound GetFullvwProductOutboundById(int Id)
        {
            return Context.vwProductOutbound.SingleOrDefault(item => item.Id == Id );
        }
        public vwProductOutbound GetFullvwProductOutboundByCode(string Code)
        {
            return Context.vwProductOutbound.SingleOrDefault(item => item.Code == Code);
        }
