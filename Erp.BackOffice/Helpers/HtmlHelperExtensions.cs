...
namespace Erp.BackOffice.Helpers
{
    ...
    public static class HtmlHelperExtensions
    {
        ...
        public static MvcHtmlString CustomTextboxCodeFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TProperty>> expression, string module, string placeHolder = null, string inputMask = null, WidthType widthType = WidthType.span12, bool IsCheckValidation = true, Dictionary<string, object> htmlAttributeInput = null, string stringFormat = null, string labelClass = "control-label col-lg-5 col-md-4 col-sm-4", string controlClass = "col-lg-7 col-md-8 col-sm-8")
        {
            var manualOrderNo = Erp.BackOffice.Helpers.Common.GetSetting("manualOrderNo_" + module);
            if (manualOrderNo == "true")
            {
                return CustomTextboxFor(htmlHelper, expression, placeHolder, inputMask, widthType, IsCheckValidation, htmlAttributeInput, stringFormat, labelClass, controlClass, "", "");
            }
            else  
            {
                return new MvcHtmlString(htmlHelper.HiddenFor(expression).ToHtmlString());
            }
        }
        ...
        #region CustomTextboxForSelect2
        public static MvcHtmlString CustomTextboxForSelect2<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TProperty>> expression, string placeHolder, bool IsCheckValidation, string url = "", string url2 = "", string parameter = "Name", string functionSelect = "", string labelClass = "control-label col-lg-5 col-md-4 col-sm-4", string controlClass = "col-lg-7 col-md-8 col-sm-8")
        {
            var result = htmlHelper.ViewData.Model != null ? ((LambdaExpression)expression).Compile().DynamicInvoke(htmlHelper.ViewData.Model) : string.Empty;
            result = result == null ? string.Empty : result;
            var fullHtmlFieldName = ExpressionHelper.GetExpressionText(expression);
            ...
            var titleUI = htmlHelper.LabelFor(expression, new { @class = labelClass });
            var validErrorClass = htmlHelper.ValidationErrorFor(expression, "error");
            ViewDataDictionary viewDataDictionary = new ViewDataDictionary { { "titleUI", titleUI }, { "value", result }, { "validError", validErrorClass }, { "controlClass", controlClass }, { "url", url }, { "placeHolder", placeHolder }, { "fieldName", fullHtmlFieldName }, { "url2", url2 }, { "parameter", parameter }, { "functionSelect", functionSelect } };
            if (IsCheckValidation)
            {
                viewDataDictionary.Add("validUI", htmlHelper.ValidationMessageFor(expression, null, new { @class = "help-inline" }));
            }
        ...
        public static MvcHtmlString CustomTextboxForSelect2Customer<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TProperty>> expression, string placeHolder, bool IsCheckValidation, string url = "", string url2 = "", string urlAdd = "", string parameter = "Name", string labelClass = "control-label col-lg-5 col-md-4 col-sm-4", string controlClass = "col-lg-7 col-md-8 col-sm-8")
        {
            var result = htmlHelper.ViewData.Model != null ? ((LambdaExpression)expression).Compile().DynamicInvoke(htmlHelper.ViewData.Model) : string.Empty;
            result = result == null ? string.Empty : result;
            var fullHtmlFieldName = ExpressionHelper.GetExpressionText(expression);
            ...
            var titleUI = htmlHelper.LabelFor(expression, new { @class = labelClass });
            var validErrorClass = htmlHelper.ValidationErrorFor(expression, "error");
            ViewDataDictionary viewDataDictionary = new ViewDataDictionary { { "titleUI", titleUI }, { "value", result }, { "validError", validErrorClass }, { "controlClass", controlClass }, { "url", url }, { "placeHolder", placeHolder }, { "fieldName", fullHtmlFieldName }, { "url2", url2 }, { "urlAdd", urlAdd }, { "parameter", parameter } };
            if (IsCheckValidation)
            {
                viewDataDictionary.Add("validUI", htmlHelper.ValidationMessageFor(expression, null, new { @class = "help-inline" }));
            }
            return htmlHelper.Partial("_Select2CustomerInputFieldTemplatePartial", viewDataDictionary);
        }
        #endregion
        ...
        public static MvcHtmlString ButtonExportExcel(this HtmlHelper htmlHelper, string urlPost, List<string> arraySearch)
        {
            return htmlHelper.Partial("_ButtonExportExcel", new ViewDataDictionary { { "arraySearch", arraySearch }, { "urlPost", urlPost } });
        }

        public static MvcHtmlString Style_CssTableMobile(this HtmlHelper htmlHelper, string className, List<string> arrayHeader)
        {
            return htmlHelper.Partial("_CssTableMobilePartial", new ViewDataDictionary { { "arrayHeader", arrayHeader }, { "name", className } });
        }

        public static MvcHtmlString Style_CssTableFreezeTop(this HtmlHelper htmlHelper, string className, int width, int colCount, int? marginBottom = null, int? marginScroll = null, List<int> arrayWidthChange = null)
        {
            return htmlHelper.Partial("_CssTableFreezeTopPartial",
                                      new ViewDataDictionary {
                                      { "arrayWidthChange", arrayWidthChange },
                                      { "colCount", colCount },
                                      { "width", width },
                                      { "marginBottom", marginBottom },
                                      { "marginScroll", marginScroll },
                                      { "name", className }
                                      });
        }
        // -------
        ...
        {
            string url = UrlHelper.GenerateContentUrl("~/assets/js/select2.min.js", htmlHelper.ViewContext.HttpContext);
            return MvcHtmlString.Create("<script src="+url+ " type=\"text/javascript\"></script>");
        }
        #endregion
        ...
        public static MvcHtmlString ModulePopupFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TProperty>> expression, string moduleName, string displayText, bool showAddButton = true, bool IsCheckValidation = false, bool bReadOnly = false, string addClassForLabelField = null, string addClassForControlField = null)
        {
            ...
            var inputUIPartial = htmlHelper.Partial("_ModulePopupPartial", new ViewDataDictionary { { "inputUI", inputUI }, { "inputName", fullHtmlFieldName }, { "moduleName", moduleName }, { "displayText", displayText }, { "readOnly", bReadOnly }, { "showAddButton", showAddButton }, { "IsCheckValidation", IsCheckValidation } });
        ...
        #region CameraPickerFor
        public static MvcHtmlString CameraPickerListFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TProperty>> expression, int? quantityImage = 1, int? max_size = 720, string folder = null)
        {
            var result = htmlHelper.ViewData.Model != null ? ((LambdaExpression)expression).Compile().DynamicInvoke(htmlHelper.ViewData.Model) : null;
            List<string> data_full = new List<string>();
            ...
            if (result != null)
            {
                ...
                {
                    data.Add(item);
                    data_full.Add("/files/" + folder + "/" + item);
                }
            }

            ViewDataDictionary viewDataDictionary = new ViewDataDictionary { { "data", data }, { "data_full", data_full }, { "QuantityImage", quantityImage }, { "max_size", max_size } };
            viewDataDictionary.Add("validUI", htmlHelper.ValidationMessageFor(expression, null, new { @class = "help-inline" }));

            return htmlHelper.Partial("_CameraFileInput", viewDataDictionary);
        }
        #endregion
    }
}