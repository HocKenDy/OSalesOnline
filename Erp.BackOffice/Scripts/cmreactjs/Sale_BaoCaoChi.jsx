    ...
    function table(data) {
        ...
        return (
            <table className="table table-bordered table-responsive" id="cTable">
                <thead>
                    <tr>
                        <th colSpan="10" className="cell-center"><span style={{ fontSize: 16 }}><b>{title} từ ngày {StartDate} đến ngày {EndDate}</b></span></th>
                    </tr>
                    <tr>
                        ...
                        <th className="cell-center" style={{ width: 150 }}>Ngày chứng từ</th>
                ...
                <tfoot>
                    <tr>
                        <td colSpan="6" className="text-right text-uppercase" style={{ fontWeight: 'bold' }}>Tổng cộng</td>
