...
namespace Erp.BackOffice.Crm.Controllers
{
    ...
    public class ProcessController : Controller
    {
        ...
        public static void Run(string moduleName, string actionName, int? IdData, int? UserId, object beforeEntityData = null, object afterEntityData = null)
        {
