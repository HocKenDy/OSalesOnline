...
{
    public class <MODULE_NAME>Repository : RepositoryReadonly<<MODULE_NAME>>, I<MODULE_NAME>Repository
    {
        public <MODULE_NAME>Repository(IDbFactory dbFactory) : base(dbFactory) { }
    }

    public interface I<MODULE_NAME>Repository : IRepositoryReadonly<<MODULE_NAME>>
    {
    }
}
