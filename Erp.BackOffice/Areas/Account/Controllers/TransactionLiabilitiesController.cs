...
namespace Erp.BackOffice.Account.Controllers
{
    ...
    public class TransactionLiabilitiesController : Controller
    {
        ...
        [HttpPost]
        public ActionResult ResolveLiabilities(List<ResolveLiabilitiesViewModel> model, string PaymentMethod, double? Amount, string TargetCode, string TargetModule)
        {
            ...
            else
            {
                ...
                payment.Code = Erp.BackOffice.Helpers.Common.GetOrderNo("PaymentSupplier");
                paymentRepository.UpdatePayment(payment);
                Erp.BackOffice.Helpers.Common.SetOrderNo("PaymentSupplier");
                foreach (var item in model)
                {
                    if (item.Amount != null)
                    {
