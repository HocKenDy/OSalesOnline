...
namespace Erp.BackOffice.Account.Controllers
{
    ...
    public class ReceiptController : Controller
    {
        ...
        public ActionResult Print(int Id)
        {
            ...
            model.Content = model.Content.Replace("{Money}", Erp.BackOffice.Helpers.Common.PhanCachHangNgan2(receipt.Amount).ToString());
            ...
            model.Content = model.Content.Replace("{MoneyText}", Erp.BackOffice.Helpers.Common.ChuyenSoThanhChu_2(Convert.ToInt32(receipt.Amount.Value)));
