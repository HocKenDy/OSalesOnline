...
namespace Erp.BackOffice.Account
{
    public class AccountAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            context.MapRoute(
            "Account_ReceiptDetail",
            "ReceiptDetail/{action}/{id}",
            new { controller = "ReceiptDetail", action = "Index", id = UrlParameter.Optional }
            );
        ...
        private static void RegisterAutoMapperMap()
        {
            ...
            AutoMapper.Mapper.CreateMap<Domain.Account.Entities.TransactionLiabilities, TransactionLiabilitiesViewModel>();
            AutoMapper.Mapper.CreateMap<TransactionLiabilitiesViewModel, Domain.Account.Entities.TransactionLiabilities>();
            ...
            AutoMapper.Mapper.CreateMap<Domain.Account.Entities.TransactionRelationship, TransactionRelationshipViewModel>();
            ...
            AutoMapper.Mapper.CreateMap<Domain.Account.Entities.ReceiptDetail, ReceiptDetailViewModel>();
            AutoMapper.Mapper.CreateMap<ReceiptDetailViewModel, Domain.Account.Entities.ReceiptDetail>();

            AutoMapper.Mapper.CreateMap<Domain.Account.Entities.vwCustomerForInvoice, CustomerJsonModel>();
