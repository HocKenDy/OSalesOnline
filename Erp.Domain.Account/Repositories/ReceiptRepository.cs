...
namespace Erp.Domain.Account.Repositories
{
    public class ReceiptRepository : GenericRepository<ErpAccountDbContext, Receipt>, IReceiptRepository
    {
        ...
        public IQueryable<vwReceipt> GetAllvwReceipt()
        {
        ...
        public vwReceipt GetvwReceiptByCode(string Code)
        {
            return Context.vwReceipt.SingleOrDefault(item => item.Code.Contains(Code));
        }
        /// <summary>
