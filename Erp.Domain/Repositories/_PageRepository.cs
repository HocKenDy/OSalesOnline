...
namespace Erp.Domain.Repositories
{
    public class PageRepository : GenericRepository<ErpDbContext, Page>, IPageRepository
    {
        ...
        public IQueryable<vwPage> GetPages()
        {
        ...
        public IEnumerable<vwPage> GetPagesUserTypeAccessRight(int userTypeId)
        {
            return Context.vwPages.SqlQuery("GetPagesUserTypeAccessRight {0}", userTypeId).AsEnumerable();
        }
    }
}
